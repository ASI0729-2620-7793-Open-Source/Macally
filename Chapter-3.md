...
En el Impact Mapping del modelo de negocio digital de NUBI, el equipo elaboró el mapa en UXPressia partiendo de un Business Goal principal que cumple con criterios SMART: “Mejorar la capacidad de niños y adolescentes neurodivergentes y sus cuidadores para gestionar situaciones de desregulación emocional o sensorial mediante NUBI, logrando que al menos el 80 % de los cuidadores complete correctamente las guías de actuación, el 70 % de los usuarios utilice herramientas de autorregulación y el 80 % pueda comunicar una necesidad mediante mecanismos visuales durante las pruebas de la solución”. A partir de este objetivo se incorporaron como Actors/Personas a los perfiles previamente definidos: Mateo (cuidador primario) y Diana (adolescente neurodivergente). Para cada uno se identificaron los Impacts esperados. En el caso de Mateo, se busca que pueda actuar con mayor rapidez y seguridad durante una situación de desregulación, brindar un acompañamiento adaptado a las necesidades del usuario y aprender de episodios anteriores para mejorar futuras intervenciones. En el caso de Diana, se busca fomentar una mayor autonomía para autorregularse, facilitar la comunicación de sus necesidades sin depender exclusivamente del lenguaje verbal y permitirle solicitar apoyo rápidamente cuando lo necesite.

A partir de estos impactos se definieron los Deliverables que NUBI debe ofrecer para generar dichos cambios en el comportamiento de los usuarios. Para el cuidador se consideran funcionalidades como el Modo SOS, las guías de actuación paso a paso, la personalización según las sensibilidades del usuario, el registro e historial de episodios y las recomendaciones personalizadas. Para el niño o adolescente neurodivergente se incluyen la interfaz de autorregulación, estímulos visuales y auditivos, el modo de baja estimulación, el temporizador de calma, el tablero de Comunicación Aumentativa y Alternativa (CAA) y el sistema de solicitud de ayuda y notificaciones al cuidador. Finalmente, estos entregables se relacionan con las User Stories definidas en el proyecto, permitiendo establecer una trazabilidad clara entre el objetivo de negocio, los actores, los impactos esperados y las funcionalidades que serán desarrolladas en NUBI.
